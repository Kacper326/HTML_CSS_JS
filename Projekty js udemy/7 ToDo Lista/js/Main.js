...
let addBtn  // przcisk ADD - dodaje nowy elementy do listy
...
const prepareDOMEvenst = () => {
    addBtn.addEventListener('click', addNewTodo)
    ulList.addEventListener('click', checkClick)
    popupCloseBtn.addEventListener('click', closePopup)
    popupAddBtn.addEventListener('click', changeTodoInput)
...
const createTooldArea = (newTodo) => {
    ...
    newDivTools.append(completeBtn,editBtn,deleteBtn)
}
